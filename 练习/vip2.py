...
def about():
    abc = '''
    http://www.iqiyi.com/v_19rrb2u62s.html?fc=82992814760eeeac5
    '''
...
if __name__ == '__main__':
    ...
    lab_movie_gallery = tkinter.Label(root,text = '视频播放频道')
    lab_movie_gallery.place(x=20, y=20, width=100, height=20)
    varRadio = tkinter.IntVar(value=1)
    Radiobutton1_movie_gallery = tkinter.Radiobutton(root, variable=varRadio, value=0, text='视频频道1')
    Radiobutton2_movie_gallery = tkinter.Radiobutton(root, variable=varRadio, value=1, text='视频频道2')
    ...
    lab_movie_gallery = tkinter.Label(root, text='视频播放链接')
    lab_movie_gallery.place(x=20, y=60, width=100, height=20)
    ...
    button_movie_link.place(x=440, y=60, width=300, height=20)
    ...
    button_movie4 = tkinter.Button(root, text='芒果TV', command=openmg)
    button_movie4.place(x=420, y=200, width=100, height=60)
